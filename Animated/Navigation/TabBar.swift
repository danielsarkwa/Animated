...
//  Animated
//
//  Created by Daniel Yeboah on 12.6.2023.
//
        ...
        ForEach(tabItems) { item in
            Button {
                ...
                item.icon.view()
                    ...
                    .background(
                        VStack {
                            RoundedRectangle(cornerRadius: 2) // rectangle uses the accent color because it is in a button view // .fill(Color.accentColor)
